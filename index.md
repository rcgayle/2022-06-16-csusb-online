...
venue: "CSU San Bernardino"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "https://csusb.zoom.us/j/83623312306"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "June 16th & 17th, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "11.30a-5p (Day 1); 8.30a-5p (Day 2)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Richard Gayle", "Pauline Karega", "Elif Dede Yildirim"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Quinn Asena", "Benjamin Becerra", "Essia Hamouda", "Blessing Nwogu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["Essia.Hamouda@csusb.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2022-06-16-csusb-online # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p>
  We will use this <a href="{{ page.collaborative_notes }}"><b>Etherpad collaborative document</b></a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
<hr/>
{% endif %}
